...
public interface ProcessMeasureCheckMapper {
    ...
    List<ProcessMeasureListVO> selectByPageAndRows(PageModel pageModel);

    Integer count();

    List<ProcessMeasureListVO> selectByPMeasureId(@Param("searchValue") String searchValue, @Param("pageModel") PageModel pageModel);

    Integer selectCountByPMeasureId(String searchValue);
}